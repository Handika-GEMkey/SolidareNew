...
namespace BantuAnakAsuh.Models
{
    ...
    {
        public String id_anak_asuh { get; set; } //for list anak asuh donatur
        public String id_orangtua_asli { get; set; }
        public String nama_anak_asuh { get; set; } //for list anak asuh donatur
        public String nama_donatur { get; set; }
        ...
        public String jenjang_pendidikan { get; set; } //for list anak asuh donatur
        public String kelas { get; set; }
        public String nama_sekolah { get; set; }
        public String foto_anak { get; set; } //for list anak asuh donatur
